...
class MergeEnvVariation(MergeEnv):
    """Create other vehicles randomly"""
    ...
    def _is_terminated(self) -> bool:
        """terminate earlier, after obstacle"""
        return self.vehicle.crashed or bool(self.vehicle.position[0] > 320)
